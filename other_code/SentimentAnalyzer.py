...
class SVMClassifier:
    ...
    def getSVMTrainedClassifer(self,trainingDataFile):
    ...
    def classify(self):
        for i in self.tweets:
            ...
            self.results[i] = res
        print self.results
        #end outer loopclassifierDumpFile,
    #end
...
def main():
    data = json.load(open('../data_files/MSFT_2013-11-21.json'))
    testarray  = {}
    testtweetarray = []
    for key in data.keys():
        testtweetarray.append(key)

    #print testtweetarray
    testarray[0] = testtweetarray
    sc = SVMClassifier(testarray,'training2.csv')
    sc.classify()
